...
public class AssignmentUI extends JPanel {
    ...
    private Assignment getAssignmentFromForm() {
        ...
        String assignmentDateString = dateFormat.format(selectedDate);
        ...
        assignment.setAssignmentDate(assignmentDateString);
    ...
    private void setFormValuesFromTable(int selectedRow) {
        ...
        String dateString = assignmentTableModel.getValueAt(selectedRow, 4).toString();
        try {
            Date date = dateFormat.parse(dateString);
            dateChooser.setDate(date);
        } catch (java.text.ParseException ex) {
            System.err.println("Error parsiing date from table: " + dateString + " - " + ex.getMessage());
